...
// SIDEBAR COMPONENT
// ========================
function Sidebar({ dark, collapsed, setCollapsed, activeView, setActiveView, categories, activeCategory, setActiveCategory, reports, favorites, requests = [], user, onLogout, isUserAdmin }) {
  const theme = dark ? darkTheme : lightTheme;
...
function Dashboard({ user, onLogout }) {
  ...
  const submitActionModal = () => {
    ...
    setActionModal(null);
    setActionDetails("");
    showToast(actionModal.type === "issue" ? "Problema registrado para seguimiento BI" : "Solicitud de cambio registrada");
  };
