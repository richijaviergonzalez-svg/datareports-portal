...
function Dashboard({ user, onLogout }) {
  ...
  if (selectedReport) {
    ...
    return (
      <div style={{ fontFamily: "'Outfit', system-ui", minHeight: "100vh", background: theme.bg, display: "flex", flexDirection: "column" }}>
        ...
        {/* Report embed area */}
        <div style={{ flex: 1, padding: "12px 16px 16px", animation: "fadeUp .3s ease-out", overflow: "hidden" }}>
          <div id="report-embed-container" style={{ height: "100%", background: theme.bgCard, borderRadius: 16, border: `1px solid ${theme.border}`, overflow: "hidden", display: "flex", flexDirection: "column" }}>
                  ...
                  return (<>
                    ...
                    <div style={{ flex: 1, overflow: "auto", padding: "20px 28px 28px" }}>
                      ...
                      <div style={{ marginBottom: 20 }}>
                        ...
                        <p style={{ fontSize: 13, color: theme.text, lineHeight: 1.7 }}>{detailReport.description}</p>
                      </div>
                      ...
                      <div style={{ marginBottom: 20 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                          ...
                          <button onClick={() => alert("Funcionalidad de reporte de problema próximamente. Contactá al equipo BI.")} style={{
                            display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderRadius: 12,
                          ...
                          <button onClick={() => alert("Funcionalidad de solicitud de cambio próximamente. Contactá al equipo BI.")} style={{
                            display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderRadius: 12,
                            border: `1px solid ${theme.border}`, background: theme.bgCard,
                            cursor: "pointer", transition: "all .2s", width: "100%", textAlign: "left",
                          }}>
